...
(jump | go) [to] clip: user.disassembler_jump_clipboard()
[(jump | go) to] next call: user.disassembler_next_call()
[(jump | go) to] last call: user.disassembler_previous_call()
[go] (funk | function) start: user.disassembler_function_start()
[go] (funk | function) end: user.disassembler_function_end()
[go] (funk | function) next: user.disassembler_next_function()
[go] (funk | function) last: user.disassembler_previous_function()
...
rename: disassembler_change_label()
rename clip: disassembler_change_label_clipboard()
