...
# Show and hide hints
(hints|rango) refresh: user.rango_command_without_target("refreshHints")
(hints|rango) toggle: user.rango_command_without_target("toggleHints")
parrot(tut):
  user.rango_command_without_target("toggleHints")
(hints|rango) on [{user.rango_hints_toggle_levels}]:
  user.rango_command_without_target("enableHints", rango_hints_toggle_levels or "global")
(hints|rango) off [{user.rango_hints_toggle_levels}]:
  user.rango_command_without_target("disableHints", rango_hints_toggle_levels or "global")
(hints|rango) reset {user.rango_hints_toggle_levels}:
