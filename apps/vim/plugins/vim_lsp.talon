...
(jump|lisp) implementation: user.vim_command_mode(':exe ":lua vim.lsp.buf.implementation()"\n')
(jump|lisp) (definition|deaf): user.vim_command_mode(':exe ":lua vim.lsp.buf.definition()"\n')
(jump|lisp) (highlight|light): user.vim_command_mode(':exe ":lua vim.lsp.buf.document_highlight()"\n')
...
(jump|lisp) in coming: user.vim_command_mode(':exe ":lua vim.lsp.buf.incoming_calls()"\n')
(jump|lisp) out going: user.vim_command_mode(':exe ":lua vim.lsp.buf.outgoing_calls()"\n')
(jump|peak) (references|ref|callers): user.vim_command_mode(':exe ":lua vim.lsp.buf.references()"\n')
