...
service list running: "systemctl list-units --type=service --state=running --no-pager\n"
...
service find running: "systemctl list-files --type=service --state=running --no-pager | grep "
service find active: "systemctl list-files --type=service --state=active --no-pager | grep "
service find: "systemctl list-unit-files --type=service --no-pager | grep "
service list disabled: "systemctl list-unit-files --type=service --no-pager | grep disabled\n"
