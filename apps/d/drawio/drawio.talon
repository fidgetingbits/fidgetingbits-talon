app: drawio
-
# XXX - this should probably be in generic editor or something?
undo: key(ctrl-z)
...
cut: key(ctrl-x)
paste: key(ctrl-v)
print diagram: key(ctrl-p)
(duplicate|dupe) [that]: key(ctrl-d)
edit data: key(ctrl-m)
