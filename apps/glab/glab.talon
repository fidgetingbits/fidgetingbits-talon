...
gitlab project create help:
    "glab project create --help\n"
gitlab project (create | new) public:
    "glab project create -P "
gitlab project (create | new) [private]:
    "glab project create -p "
gitlab project search:
    "glab search "
gitlab project search help:
    "glab search --help\n"

# issue
gitlab issue list help:
