...
time (war | warrior) start <number_small> minutes ago:
    "timew start {number_small}mins ago "
time (war | warrior) start <number_small> hours ago:
    "timew start {number_small}hours ago "
time (war | warrior) start: "timew start "
time (war | warrior) stop now: "timew stop\n"
time (war | warrior) stop: "timew stop "
time (war | warrior) stop <number_small> minutes ago:
    "timew stop {number_small}mins ago "
time (war | warrior) stop <number_small> hours ago:
    "timew stop {number_small}hours ago "
